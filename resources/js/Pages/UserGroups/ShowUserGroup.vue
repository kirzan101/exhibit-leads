        ...
        <div class="p-1">
            <b-form @submit.prevent="submit">
                ...
                <UserGroupPermissionTable
                    ...
                    :modules="modules"
                    :user_group_permissions="user_group.user_group_permissions"
                    :disabled="disabled"
...
export default {
    ...
    data() {
        return {
            ...
            form: {
                ...
                department: this.user_group.department,
                description: this.user_group.description,
                property_id: this.user_group.property_id,
                id: this.user_group.id,
                code: this.user_group.code,
                permissions: [],
            },
            property_locations: [
    ...
    methods: {
        submit() {
            ...
            router.post(`/usergroups/${this.user_group.id}`, {
                _method: "PUT",
                forceFormData: true,
                ...this.form,
            });
