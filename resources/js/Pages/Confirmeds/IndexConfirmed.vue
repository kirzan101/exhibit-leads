...
import ConfirmedTable from "../../Components/ConfirmedTable.vue";
    ...
    data() {
        return {
            ...
            fields: [
                ...
                { key: "assigned_employee_name", label: "Booker", sortable: true },
                { key: "assigned_exhibitor_name", label: "Exhibitor", sortable: true },
                { key: "assigned_confirmer_name", label: "Confirmer", sortable: true },
