<template>
    <b-container fluid>
        <Head>
            <title>Assigned Lead Details</title>
        </Head>
        <h5>
            <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6 align-right">
                    Assigned to: {{ assigned_confirmer }}
                </div>
            </div>
        </h5>
        <div class="p-1">
                    ...
                    <b-col sm="4">
                        ...
                        >
                            <b-form-input
                                ...
                                :state="
                                    errors.nature_of_business ? false : null
                                "
                                readonly
                            ></b-form-input>
                            <b-form-invalid-feedback
                    ...
                    <b-col sm="3">
                        ...
                        >
                            <b-form-select
                                ...
                                :state="
                                    errors.internet_connection ? false : null
                                "
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                property_assigned: this.lead.property_assigned,
