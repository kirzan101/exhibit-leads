            ...
            <h5>
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div
                            v-if="
                                user_group == 'rois' || user_group == 'admin'
                            "
                        >
                            <!-- assign leads to an employee start -->
                            <div v-if="check_access('rois', 'create')">
                                <b-button
...
import RoiPaginateTable from "../../Components/PaginateTable/RoiPaginateTable.vue";
