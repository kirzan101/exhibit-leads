...
class SurveyController extends Controller
{
    ...
    /**
     * Get the paginated Survey leads
     *
    ...
    public function index(Request $request)
    {
        ...
        $leads = $this->leadService->indexPaginateSurveyLead($request->toArray());
        ...
        return Inertia::render('Surveys/IndexPaginateSurvey', [
            'sortBy' => $sort_by,
            ...
            'employees' => $this->employeeService->indexTeamLeadEmployeesByCode('SURVEYS'),
            'occupation_list' => Helper::occupationList(),
            'venues' => $this->venueService->indexVenueService(),
            'sources' => Helper::leadSource('SURVEY'),
